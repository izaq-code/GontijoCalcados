...
router.post('/calcado', (req, res) => {
  const { nome, espe_linha, espacamento_da_costura, temp_equi, cor_linha, tam_costura, temp_sec, reg_equip, img_calcado, id_tinta, id_material, id_cadarco, id_solado, id_adesivo, id_tip_tinta } = req.body;
